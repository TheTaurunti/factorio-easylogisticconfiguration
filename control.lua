...
script.on_event("elc-copy", function(event)
  ...
  local settings_copy_function = _VALID_ELC_COPY_TARGETS[entity.prototype.type]
...
script.on_event("elc-paste", function(event)
